...
sleep 20
gnome-terminal -- bash -c "python3 /home/ruben/FIC/Q8/TFG/clean_partition/python_code/mqttClientPart.py [3] 2400 2100 piw /home/ruben/FIC/Q8/TFG/clean_partition/scenariosimul/reordered_mnist_train.csv; exec bash"